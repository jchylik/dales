# COMBLE intercomparion README.md

This is the updated readme file for the Dales setup of COMBLE intercomparison page.

Discussion on our Slack channel: [comble-mip](https://join.slack.com/share/enQtNjUyMDk5MzQ5NTg3Ni1kMTMzZjAzZTliNmUxYzhlMjg2NzQ0MTU4YzdjMmY0M2M3ZjRhNGFiNjJjMWNjYzBiYjEyNWY3YTM0YjI0YWVk "comble-mip Slack channel")
...
Our modified COMBLE case is located in testbed folder:  [COMBLE case for Dales](/data/testbed/DALES/cases/COMBLE/dales_conversion "COMBLE case folder")
 
Use the namoption file: [namoptions_comble_control1.nml](/data/testbed/DALES/cases/COMBLE/dales_conversion/namoptions_comble_control1.nml "namoptions for control 1 case")


This covers the control 1 case:
  | Fixed droplet    | - Nd = 20/cm3  | 



Branch on our Redmine:  [dev-comble-dales43-sb3-radfullice](https://redmine.uni-koeln.de/projects/dales-cgn/repository?utf8=%E2%9C%93&rev=dev-comble-dales43-sb3-radfullice "redmine repository")
Case folder: [case/comble/comble-dales-start/](https://redmine.uni-koeln.de/projects/dales-cgn/repository/revisions/dev-comble-dales43-sb3-radfullice/show/cases/comble/comble-dales-start "COMBLE control 1 case files")



The main configuration: [COMBLE configuration page](https://arm-development.github.io/comble-mip/main_configuration.html "COMBLE configuration page")

Below is the original readme from: [COMBLE github page](https://github.com/ARM-Development/comble-mip "COMBLE github")
