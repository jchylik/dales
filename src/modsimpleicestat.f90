...
implicit none
private
PUBLIC  :: initsimpleicestat, simpleicestat, exitsimpleicestat, simpleicetend
save
!NetCDF variables
...
subroutine initsimpleicestat
  ...
  end subroutine initsimpleicestat
...
!> General routine, does the timekeeping
  subroutine simpleicestat
    ...
    if (timee >= tnext) then
      tnext = tnext + idtav
      call dosimpleicestat
    end if
    if (timee >= tnextwrite) then
      tnextwrite = tnextwrite + itimeav
      call writesimpleicestat
    end if

  end subroutine simpleicestat
...
!> Performs the calculations for rainrate etc.
  ...
  end subroutine dosimpleicestat
...
!> Write the stats to file
  ...
  end subroutine writesimpleicestat

!------------------------------------------------------------------------------!

  subroutine exitsimpleicestat
    implicit none
    if (.not. lmicrostat)  return
    ...
    deallocate(precavl    , &
         ...
         Dvrav    , &
         Dvrmn    )
  end subroutine exitsimpleicestat
